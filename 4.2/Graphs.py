...
class Graphs:
    ...
    def createCanvas(self,fig1,fig2,fig3, fig4):
        ...
        totalVolumeViewButton = ttk.Button(figTwoButtonFrame, text = "VIEW"  , command = lambda: self.expandGraph(1))
        ...
        totalContainersViewButton = ttk.Button(figThreeButtonFrame, text = "VIEW", command = lambda: self.expandGraph(2))
        ...
        totalSocViewButton = ttk.Button(figFourButtonFrame, text = "VIEW",  command = lambda: self.expandGraph(3))
    ...
    def graph(self):
        ...
        """
        self.root.protocol("WM_DELETE_WINDOW", self.closeWindow(1))
