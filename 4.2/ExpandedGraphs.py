...
class ExpandedGraphs:
    ...
    def activeWidgets(self, frame,name_data,lineHolder, operation,ax1,figure):
        ...
        # title 
        if(operation == 1):
            titlelabel = tk.Label(background, text = "Active Tanks List")
            titlelabel.pack( expand= True, side= "top",anchor='n')
        ...
        selectDeSelectFrame.pack(pady = 10)
