...
public class p {
    ...
    // checks the row and column that was shot at
        ...
        }else// it does contain a ship
        {
            ...
            else
            {
                ...
                if(totalShip <= 0)
                {
                    ...
                    write.println("GAME END:" + letter + "-" + startColumn +":"+ currentShipName);
                }else
                {
        ...
        try {
            ...
            if (!receivedMessage.contains(("NEW GAME"))) {
                ...
                if (tcpSocket == null || tcpSocket.isClosed()) {
                    ...
                    System.out.println("Recevied From player Two" + response);
                    ...
                    while(gameOver == false)
                    {
                        ...
                        else// we are waiting for the coordinates from the other player
                        {
                            ...
                            System.out.println(hitRow + " " + hitColumn);
                            // checing if this has hit something or not
                            checkBoard(board,hitRow,hitColumn, 10,10,reader,writer);
                            currentTurn = true;
                ...
                while(gameOver == false)
                    {
                        ...
                        if(currentTurn == true)
                        {
                            ...
                            fireOperation(reader,writer, 10 ,10);
                            System.out.println("HERE" + firedRow + " "+ firedColumn);
                            response = reader.readLine();
                            System.out.println(response);
                            currentTurn = false;
                            // update the enemy board at fireRow and columnRow
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    if (isFirstIteration) {
                        port = 9000 + (int) (Math.random() * 101); // Random port between 9000 and 9100 for the first
                                                                   // iteration
                    ...
                    // Send an acknowledgment back to playerOne
                    String acknowledgmentMessage = "Received your message";
                    ...
                    DatagramPacket acknowledgmentPacket = new DatagramPacket(acknowledgmentData,
                            acknowledgmentData.length, receivePacket.getAddress(), receivePacket.getPort());
