...
# contianer is made up of batteries so (Number of batteres, array for each batteries current and max capcity[(12,12)])
class Container:
    def __init__(self, batteries, currentCapacity,maxCapacity):
        self.batteries = batteries
        self.currentCapacityOfBattery = currentCapacity
        self.maxCapacityOfBattery = maxCapacity
