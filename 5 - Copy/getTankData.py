...
class GetTankData:
    ...
    def calculateData(self):
        ...
        for energy in self.difference:
            ...
            for tank in temporaryTanks:
             # recording the name, values, and soc 
             individualTankRecord.append([tank.tName, tank.currentChargedCapacity(), (tank.currentChargedCapacity()/tank.volume) * 100 ,currentTime])
        ...
        return volume, individualTankRecord, totalSocOverTime
